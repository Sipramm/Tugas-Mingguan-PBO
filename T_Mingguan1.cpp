...
int main()
{
    ...
    if (pilih == 1)
    { // ini adalah penggunaan percabangan menggunakan if-else
        cout << "anda memilih perulangan for " << endl;
        for (int a = 1; a <= 10; a++)
        { // ini adalah perulangan menggunakan for
            cout << a;
        }
    }
    else if (pilih == 2)
    {
        ...
        int a = 1;
        while (a <= 10)
        { // ini adalah penggunaan perulangan while
            cout << a;
            a++;
        }
    }
    else if (pilih == 3)
    {
        ...
        int a = 11;
        do
        { // ini adalah penggunaan perulangan do-while
            cout << a << endl;
            a++;
        } while (a <= 10);
